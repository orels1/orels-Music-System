      ...
      >
        <defs>
          <radialGradient id={id} cy="100%">
            <stop offset="0%" stopColor="rgba(174, 248, 56, 0.3)" />
            <stop offset="53.95%" stopColor="rgba(0, 255, 55, 0.09)" />
...
const MENU_ITEMS: Record<string, Array<{
  ...
  'Components': [
    { name: 'Music System', href: '#music-system' },
    { name: 'Global Playlist', href: '#global-playlist' },
    { name: 'Local Playlist', href: '#local-playlist' },
    { name: 'Mute Zone', href: '#mute-zone' },
  ],
}
        ...
        <div className="container m-auto flex flex-col lg:flex-row items-center justify-between">
          <div className="flex">
            <Link href="/" className="inline-flex items-center gap-3">
              ...
              <span className="inline-block text-2xl font-semibold text-white font-display">orels Music System</span>
            </Link>
          </div>
