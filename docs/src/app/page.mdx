...
## v1.1.3 Release {{ date: '2024-05-19T11:22:00+04:00' }}

### <SparkleIcon /> Changes

- Relaxed the VRC Worlds SDK dependency constraint to allow for 3.4.1 and above

---

## v1.1.2 Release {{ date: '2023-11-04T21:36:00+04:00' }}
...
## v1.1.1 Release {{ date: '2023-11-03T07:38:00+04:00' }}

### <BugIcon /> Bug Fixes

- Fixed a bug where Mute Zones would not resume correctly on exit

---

## v1.1.0 Release {{ date: '2023-11-03T07:11:00+04:00' }}

### <SparkleIcon /> Enhancemenets
...
## v1.0.1 Release {{ date: '2023-10-31T01:35:48+04:00' }}
